# Course Business Manager Agent - Task Board

## Purpose

This task board lists every Course Business Manager Agent work stream that needs to be built, ordered from easiest to most difficult.
...
## First Work Stream: Operations & Future Task Planning

### Goal

Create the operating structure for the project before starting the more complex strategy, curriculum, content, marketing, sales, analytics, or agent-improvement work streams.
