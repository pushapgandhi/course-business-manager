# Course Business Manager Work Streams by Complexity

## Purpose

This file arranges the Course Business Manager Agent work streams from easiest to most difficult so tasks can be handled one by one.

The ranking is based on `main_agent_instructions.md`.

## Work Streams Ranked Easy To Difficult

| Rank | Work Stream | Complexity | Main Tools Required | Primary Output |
|---:|---|---|---|---|
...
| 8 | Marketing & Content Repurposing | Moderate to Complex | Content calendar, LinkedIn tools, Instagram tools, YouTube tools, SEO tool, newsletter tool | Posts, scripts, newsletters, blog outlines, lead magnets, calendars |
| 9 | Sales Funnel & Offer | Complex | Offer builder, pricing template, funnel map, landing page copy template, webinar outline, checkout requirements, FAQ tracker, launch checklist | Offer, pricing tiers, funnel map, landing page copy, checkout requirements, webinar, objections |
| 10 | Course Strategy & Market Research | Complex | Web research, competitor research, survey/forms, positioning canvas, pricing research | Validation, persona, pain points, competitors, positioning, course promise |
| 11 | Analytics & Business Intelligence | Complex | Spreadsheet/dashboard tool, sales data, lead data, campaign metrics, feedback analysis | KPI dashboard, reports, conversion analysis, recommendations |
| 12 | Agent-Building & Improvement | Most Complex | Instruction files, routing logic, test prompts, evaluation checklist, version control | Agent instructions, routing rules, tests, evaluation assets, improvements |

## Recommended Starting Work Stream

Start with **Operations & Future Task Planning**.

This is the easiest starting point because it does not require market data, sales data, completed lessons, or student feedback. It creates the operating structure needed to handle the rest of the project one task at a time.
